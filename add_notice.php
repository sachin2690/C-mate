...
?>
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Add New Notice</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
			...
			<div class="col-lg-offset-2 col-lg-6">
				<form class="form-signin" method="post" action="">
					...
					<input type="datetime-local"  placeholder="date" name="date" class="form-control" require>
					<div id="dtBox"></div><br>
					<button class="btn btn-primary" name="add_notice" type="submit">Add Notice</button>&nbsp;&nbsp;
