	...
	if($role=="Admin" || $role == "Technical")
	{
		...
		echo '<div class="row">
				<div class="col-lg-12">
					...
					Search by id:- <input type="text" name="sid" id="sid"> 
					<input type="button" value="GO" onclick="sId();">
				</div>
			</div>';
	}
...
if(sid.value !=""){
window.open("http://localhost/dashboard/C-mate%20quarter%201/search_member.php?sid="+sid.value,"_self");
}
}
</script>
	<div class="row">
