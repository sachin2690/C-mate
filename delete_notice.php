<?php
	...
	if($role != 'Admin' && $role != 'Technical' && $role != 'Teacher')
	{
	...
	<div class="row">
			<ol class="breadcrumb">
				<li><a href="home.php"><i class="fa fa-home" aria-hidden="true"></i></li>
				<li><a href="notice.php">Notice</a></li>
				<li class="active">Delete Notice</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Delete Notice</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						<form class="" method="post" action="">
							<label for="ask">Are you really want to remove this Notice?</label>
							<br>
					<div class="panel-footer">
						<div class="pull-right">
							<button class="btn btn-danger" name="yes" type="submit" id="login">Yes</button>&nbsp;&nbsp;
							<a href="notice.php" class="btn btn-default" id="login">No, go back!</a>
						</div>
					</div>
						</form>
					</div>
